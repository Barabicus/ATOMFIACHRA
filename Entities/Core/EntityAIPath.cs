...
//public class EntityAIPath : EntityComponent
//{
...
//        base.Start();
//        startHasRun = true;
//        target = new GameObject("AITarget" + gameObject.name).transform;
...
//    {
//        if (Time.time - lastRepath >= repathRate && canSearchAgain && canSearch && target != null && Entity.LivingState == EntityLivingState.Alive)
//        {
//            SearchPath();
//            return repathRate;
//        }
...
//        if (!canMove || Entity.LivingState != EntityLivingState.Alive) { return; }
